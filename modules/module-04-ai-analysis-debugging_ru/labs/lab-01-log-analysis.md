...
## Упражнение 1: Web Server Log Analysis
...
## Упражнение 2: Multi-Service Log Correlation
...
## Упражнение 3: Programmatic Log Analysis
...
> 🌐 [English version](../module-04-ai-analysis-debugging/labs/lab-01-log-analysis.md)
